...
(function () {
  ...
  var SCENARIO = {
    ...
    nodes: {
      ...
      result: { type: 'result', text: 'По вашим параметрам подберу позицию из каталога.',
        placeholder_note: 'В демонстрации карточка показана условно: конкретная модель, характеристики и ссылка появятся после подключения выгрузки каталога.',
        chips: [
